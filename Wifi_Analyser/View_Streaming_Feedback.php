            ...
            <div class="MainContainer">
                ...
                <div class="MainInsideRest">
                    ...
                    <div class="DashboardTableBox">
                       ...
                       <?php                 
$streamQuery= "SELECT Comment FROM StreamMedia";

$streamResult = mysqli_query($conn, $streamQuery) or die(mysqli_error($conn));
                       

          
          echo "<table class='streamTable' border='1'>
<tr class='streamTopRow'>
<th>Comment</th>
</tr>";

 
while($row = mysqli_fetch_assoc($streamResult))
{
 $TableClass = ($x%2 == 0)? 'streamFirstRows': 'streamTableSecondRows';
